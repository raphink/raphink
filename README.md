...
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([kube-prometheus-stack-14.4.0](https://github.com/prometheus-community/helm-charts/releases/tag/kube-prometheus-stack-14.4.0), today) - Prometheus community Helm charts
- [derailed/k9s](https://github.com/derailed/k9s) ([v0.24.5](https://github.com/derailed/k9s/releases/tag/v0.24.5), today) - 🐶 Kubernetes CLI To Manage Your Clusters In Style!
