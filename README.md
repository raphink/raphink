...
- [cilium/proxy](https://github.com/cilium/proxy) - Envoy with Cilium filters (3 days ago)
...
- [puppetlabs/puppetserver-helm-chart](https://github.com/puppetlabs/puppetserver-helm-chart) ([v6.1.0](https://github.com/puppetlabs/puppetserver-helm-chart/releases/tag/v6.1.0), 5 days ago) -  The Helm Chart for Puppet Server
...
- [docs(README): fix small typo](https://github.com/cilium/proxy/pull/73) on [cilium/proxy](https://github.com/cilium/proxy) (3 days ago)
