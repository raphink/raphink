...
- [derailed/k9s](https://github.com/derailed/k9s) ([v0.25.13](https://github.com/derailed/k9s/releases/tag/v0.25.13), today) - 🐶 Kubernetes CLI To Manage Your Clusters In Style!
- [camptocamp/devops-stack](https://github.com/camptocamp/devops-stack) ([v0.51.1](https://github.com/camptocamp/devops-stack/releases/tag/v0.51.1), today) - 🌊 An all-in-one Kubernetes ☸ stack using ArgoCD 🐙 and Terraform as base components
...
- [feat(README): add note on built-in PuppetDB SD support](https://github.com/camptocamp/prometheus-puppetdb-sd/pull/43) on [camptocamp/prometheus-puppetdb-sd](https://github.com/camptocamp/prometheus-puppetdb-sd) (6 days ago)
