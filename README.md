...
- [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ([v2.2.0](https://github.com/oboukili/terraform-provider-argocd/releases/tag/v2.2.0), 1 day ago) - Terraform provider for ArgoCD 
...
- [fix(tests): use ssh:// in TestAccArgoCDRepositoryCredentials](https://github.com/oboukili/terraform-provider-argocd/pull/128) on [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) (1 day ago)
- [fix(tests): update go-cty and terraform-json](https://github.com/oboukili/terraform-provider-argocd/pull/127) on [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) (2 days ago)
