...
- [cilium/cilium-cli](https://github.com/cilium/cilium-cli) ([v0.18.2](https://github.com/cilium/cilium-cli/releases/tag/v0.18.2), 5 days ago) - CLI to install, manage &amp; troubleshoot Kubernetes clusters running Cilium
...
- [fix: envoy circuit-breaking service should not include port number](https://github.com/cilium/cilium/pull/38158) on [cilium/cilium](https://github.com/cilium/cilium) (today)
</details>
