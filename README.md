...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.12.6](https://github.com/cilium/cilium/releases/tag/v1.12.6), 1 day ago) - eBPF-based Networking, Security, and Observability
- [cilium/hubble](https://github.com/cilium/hubble) ([v0.11.1](https://github.com/cilium/hubble/releases/tag/v0.11.1), 4 days ago) - Hubble - Network, Service &amp; Security Observability for Kubernetes using eBPF
