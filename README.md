...
- [camptocamp/k8s-demo](https://github.com/camptocamp/k8s-demo) ([v0.3.0](https://github.com/camptocamp/k8s-demo/releases/tag/v0.3.0), 4 days ago) - An all-in-one Kubernetes demo using ArgoCD as a base component
