...
- [scraly/developers-conferences-agenda](https://github.com/scraly/developers-conferences-agenda) - This repository list a maximum of conferences&#39;s date in order to help conferences organizers &amp; attendees (4 days ago)
...
- [cilium/hubble](https://github.com/cilium/hubble) - Hubble - Network, Service &amp; Security Observability for Kubernetes using eBPF (5 days ago)
...
- [puppetlabs/puppetserver-helm-chart](https://github.com/puppetlabs/puppetserver-helm-chart) ([v5.19.0](https://github.com/puppetlabs/puppetserver-helm-chart/releases/tag/v5.19.0), 1 day ago) -  The Helm Chart for Puppet Server
...
- [Add OSMC](https://github.com/scraly/developers-conferences-agenda/pull/188) on [scraly/developers-conferences-agenda](https://github.com/scraly/developers-conferences-agenda) (4 days ago)
- [Add DevOpsCon Munich](https://github.com/scraly/developers-conferences-agenda/pull/187) on [scraly/developers-conferences-agenda](https://github.com/scraly/developers-conferences-agenda) (4 days ago)
- [docs: update logos and add dark logo](https://github.com/cilium/hubble/pull/726) on [cilium/hubble](https://github.com/cilium/hubble) (5 days ago)
- [docs(README): add logo option for dark theme](https://github.com/cilium/cilium/pull/19920) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
- [docs(README): add dark logo option](https://github.com/cilium/tetragon/pull/58) on [cilium/tetragon](https://github.com/cilium/tetragon) (5 days ago)
