...
- [jetstack/cert-manager](https://github.com/jetstack/cert-manager) ([v1.4.0-beta.1](https://github.com/jetstack/cert-manager/releases/tag/v1.4.0-beta.1), today) - Automatically provision and manage TLS certificates in Kubernetes
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([kube-prometheus-stack-16.7.0](https://github.com/prometheus-community/helm-charts/releases/tag/kube-prometheus-stack-16.7.0), today) - Prometheus community Helm charts
- [camptocamp/devops-stack](https://github.com/camptocamp/devops-stack) ([v0.37.1](https://github.com/camptocamp/devops-stack/releases/tag/v0.37.1), today) - 🌊 An all-in-one Kubernetes ☸ stack using ArgoCD 🐙 and Terraform as base components
