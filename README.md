...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.12.10](https://github.com/cilium/cilium/releases/tag/v1.12.10), 2 days ago) - eBPF-based Networking, Security, and Observability
- [cilium/cilium-cli](https://github.com/cilium/cilium-cli) ([v0.14.3](https://github.com/cilium/cilium-cli/releases/tag/v0.14.3), 1 week ago) - CLI to install, manage &amp; troubleshoot Kubernetes clusters running Cilium
- [scraly/developers-conferences-agenda](https://github.com/scraly/developers-conferences-agenda) ([v1.0.2](https://github.com/scraly/developers-conferences-agenda/releases/tag/v1.0.2), 1 month ago) - This repository list a maximum of tech conferences&#39;s date and CFP in order to help conferences organizers, speakers &amp; attendees
