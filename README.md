...
- [cilium/hubble](https://github.com/cilium/hubble) ([v0.11.1](https://github.com/cilium/hubble/releases/tag/v0.11.1), today) - Hubble - Network, Service &amp; Security Observability for Kubernetes using eBPF
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.13.0-rc5](https://github.com/cilium/cilium/releases/tag/v1.13.0-rc5), today) - eBPF-based Networking, Security, and Observability
- [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ([v4.3.0](https://github.com/oboukili/terraform-provider-argocd/releases/tag/v4.3.0), 4 days ago) - Terraform provider for ArgoCD 
