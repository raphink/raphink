...
- [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ([v2.2.4](https://github.com/oboukili/terraform-provider-argocd/releases/tag/v2.2.4), 2 days ago) - Terraform provider for ArgoCD 
...
- [fix(self-signed): typos in TLS helm parameters](https://github.com/camptocamp/devops-stack-module-cert-manager/pull/5) on [camptocamp/devops-stack-module-cert-manager](https://github.com/camptocamp/devops-stack-module-cert-manager) (3 days ago)
