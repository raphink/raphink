...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.14.0-snapshot.3](https://github.com/cilium/cilium/releases/tag/v1.14.0-snapshot.3), today) - eBPF-based Networking, Security, and Observability
- [cilium/cilium-cli](https://github.com/cilium/cilium-cli) ([v0.14.6](https://github.com/cilium/cilium-cli/releases/tag/v0.14.6), today) - CLI to install, manage &amp; troubleshoot Kubernetes clusters running Cilium
