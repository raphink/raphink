...
- [cilium/cilium-service-mesh-beta](https://github.com/cilium/cilium-service-mesh-beta) - Instructions and issue tracking for Service Mesh capabilities of Cilium (2 weeks ago)
- [cilium/cilium](https://github.com/cilium/cilium) - eBPF-based Networking, Security, and Observability (2 weeks ago)
- [cilium/hubble-otel](https://github.com/cilium/hubble-otel) - Hubble adaptor for OpenTelemetry (2 weeks ago)
...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.12.0-rc2](https://github.com/cilium/cilium/releases/tag/v1.12.0-rc2), 6 days ago) - eBPF-based Networking, Security, and Observability
...
- [puppetlabs/puppetserver-helm-chart](https://github.com/puppetlabs/puppetserver-helm-chart) ([v5.17.0](https://github.com/puppetlabs/puppetserver-helm-chart/releases/tag/v5.17.0), 3 weeks ago) -  The Helm Chart for Puppet Server
- [oboukili/terraform-provider-argocd](https://github.com/oboukili/terraform-provider-argocd) ([v3.0.1](https://github.com/oboukili/terraform-provider-argocd/releases/tag/v3.0.1), 4 weeks ago) - Terraform provider for ArgoCD 
